...
- ✦ Custom SVG icons for all 6 homepage features — monoline stroke style, saved as static files in `/public/icons/`
- ✦ Loom brand mark — weave icon in header logo and hero title
- ✦ Favicon — loom weave mark as `favicon.svg`
...
- ◈ Homepage spacing uses fixed `px` values — whitespace stays constant at all browser font sizes
